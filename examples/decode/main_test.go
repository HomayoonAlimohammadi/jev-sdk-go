...
func TestRun(t *testing.T) {
	...
	// The embedded ResponseMeta was filled in, and the typed answers decoded.
	for _, want := range []string{"request req-fake-1", "status 200", "refund:", "product:", "satisfaction:"} {
